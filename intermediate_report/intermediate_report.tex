...
\label{system:slam}
To solve the simultaneous localization and mapping we use a ROS wrapper of OpenSlam's GMapping algorithm \footnote{\url{http://wiki.ros.org/gmapping}}, which is an implementation of Fast SLAM.
